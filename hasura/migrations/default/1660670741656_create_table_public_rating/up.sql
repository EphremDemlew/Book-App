CREATE TABLE "public"."rating" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "rating" numeric NOT NULL, "user_id" uuid NOT NULL, "book_id" uuid NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id") , FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON UPDATE restrict ON DELETE restrict);
